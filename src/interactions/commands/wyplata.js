...
export default {
  data: new SlashCommandBuilder()
    .setName('wyplata')
    .setDescription(
      'Zobacz jak wyglądają wypłaty 10-tego i 25-tego dnia miesiąca.',
    ),
  async execute(interaction) {
    const embedMessage = new EmbedBuilder().setColor('Greyple').setAuthor({
      ...
      .setDescription(`Wynagrodzenie za 1-15 dni miesiąca wypłacane jest 25. dnia miesiąca i obejmuje wyłącznie godziny pracy.  
                       ...
                       \nNa przykładzie możesz podejrzeć to w **[tym arkuszu](${interaction.client.config.googleSheetUrl})**.
      `);
